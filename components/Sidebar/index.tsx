        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Blog --> */}
              {/* <!-- Menu Item Tag --> */}
              {(user?.user_admin && user?.user_admin.user_admin_role.name == Role.SUPER_ADMIN) && (<li>
                <Link
                  href="/tag"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("tag") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <Suspense>
                    <TbTags />
