...
import { TUserSchema, UserSchema } from "@/modules/auth/types/login";
...
export default function LoginForm() {
    ...
    const onSubmit = async (data: TUserSchema) => {
        try {
            ...
            const { data: response } = await axios.post("/api/login", data); // Make a POST request
            
            if (!response.data.error) {
                
                login(response.data?.token?.access_token, response?.data?.token?.refresh_token, response?.data?.user)
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="flex flex-wrap items-center">
                    <div className="hidden w-full xl:block xl:w-1/2">
                        {loading ? <Loader /> : (<div className="py-17.5 px-26 text-center">
                            <Link className="mb-5.5 inline-block" href="/">
                                ...
                                <Image
                                    ...
                                    src={"/images/logo/limaadmin-dark.png"}
                                    alt="Logo"
                                    width={176}
                                    height={32}
                                />
                            ...
                            <p className="2xl:px-20">
                                Welcome to Jamil Muhammad Blog CMS
                            </p>
